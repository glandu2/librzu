...
void DESPasswordCipher::perm32(char *inblock, char *outblock)               /* 32-bit permutation at end    */
{
	REGISTER int j;
...
void DESPasswordCipher::contract(char *in48, char *out32)                   /* contract f from 48 to 32 bits*/
{
	REGISTER char *c;
	REGISTER char *i;
...
void DESPasswordCipher::f(char *right, int num, char *fret)                 /* critical cryptographic trans */
{
...
void DESPasswordCipher::iter(int num, char *inblock, char *outblock)        /* 1 churning operation         */
{
...
void DESPasswordCipher::sinit(void)
...
void DESPasswordCipher::kinit(char *key64bit)       /* initialize key schedule array*/
{
	REGISTER int i, j, l;
	int m;
...
void DESPasswordCipher::p32init(void)
...
void DESPasswordCipher::endes(char *inblock, char *outblock)                /* encrypt 64-bit inblock       */
{
...
void DESPasswordCipher::dedes(char *inblock, char *outblock)                /* decrypt 64-bit inblock       */
{
	char iters[17][8];                  /* workspace for each iteration */
	char swap[8];                       /* place to interchange L and R */
	REGISTER int i;
...
void DESPasswordCipher::DesMem( void *buf, int mlen, int isencrypting )
{                                       // process the file
	char *b;
