...
#define TS_SERVER_INFO_DEF(simple_, array_, dynarray_, count_, string_, dynstring_) \
...
#define TS_AC_SERVER_LIST_DEF(simple_, array_, dynarray_, count_, string_, dynstring_) \
