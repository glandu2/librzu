...
#define TS_ADDED_SKILL_LIST_DEF(simple_, array_, dynarray_, count_, string_, dynstring_) \
...
#define TS_SC_ADDED_SKILL_LIST_DEF(simple_, array_, dynarray_, count_, string_, dynstring_) \
