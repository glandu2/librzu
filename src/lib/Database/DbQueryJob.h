...
public:
	...
	template<typename FieldType>
	static typename std::enable_if<IfValidFieldType<FieldType>::value, void>::type addParam(
	    const char* columnName, FieldType InputType::*member, SQLLEN InputType::*nullIndicator = nullptr) {
	...
	static typename std::enable_if<IfValidFieldType<FieldType>::value, void>::type addParam(
	    ...
	    FieldType (InputType::*member)[SIZE],
	    int arrayIndex,
	    SQLLEN InputType::*nullIndicator = nullptr) {
	...
	static typename std::enable_if<IfValidFieldType<FieldType>::value, void>::type addParam(
	    const char* columnName,
	    FieldType (InputType::*member)[N][M],
	    int arrayIndexN,
	    int arrayIndexM,
	    SQLLEN InputType::*nullIndicator = nullptr) {
		addParam<FieldType>(
		    columnName, (size_t) & ((((InputType*) 0)->*member)[arrayIndexN][arrayIndexM]), nullIndicator);
	}

	template<int SIZE>
	static void addParam(const char* columnName,
	                     char (InputType::*member)[SIZE],
	                     SQLLEN InputType::*nullIndicator = nullptr) {
		addParam<char[SIZE]>(columnName, (size_t) & (((InputType*) 0)->*member), nullIndicator);
	}

	template<typename FieldType>
	static typename std::enable_if<IfValidFieldType<FieldType>::value, void>::type addOutputParam(
	    const char* columnName, FieldType InputType::*member, SQLLEN InputType::*nullIndicator = nullptr) {
	...
	static typename std::enable_if<IfValidFieldType<FieldType>::value, void>::type addOutputParam(
	    ...
	    int arrayIndexM,
	    SQLLEN InputType::*nullIndicator = nullptr) {
		addOutputParam<FieldType>(
		    columnName, (size_t) & (((InputType*) 0)->*member[arrayIndexN][arrayIndexM]), nullIndicator);
	}

	template<int SIZE>
	static void addOutputParam(const char* columnName,
	                           char (InputType::*member)[SIZE],
	                           SQLLEN InputType::*nullIndicator = nullptr) {
	...
	template<typename FieldType>
	static typename std::enable_if<IfValidFieldType<FieldType>::value, void>::type addColumn(
	    const char* columnName, FieldType OutputType::*member, bool OutputType::*nullIndicator = nullptr) {
	...
	static typename std::enable_if<IfValidFieldType<FieldType>::value, void>::type addColumn(
	    const char* columnName,
	    FieldType (OutputType::*member)[SIZE],
	    int arrayIndex,
	    bool OutputType::*nullIndicator = nullptr) {
	...
	static typename std::enable_if<IfValidFieldType<FieldType>::value, void>::type addColumn(
	    const char* columnName,
	    FieldType (OutputType::*member)[N][M],
	    int arrayIndexN,
	    int arrayIndexM,
	    bool OutputType::*nullIndicator = nullptr) {
		addColumn<FieldType>(
		    columnName, (size_t) & ((((OutputType*) 0)->*member)[arrayIndexN][arrayIndexM]), 0, nullIndicator);
	}

	template<int SIZE>
	static void addColumn(const char* columnName,
	                      char (OutputType::*member)[SIZE],
	                      bool OutputType::*nullIndicator = nullptr) {
